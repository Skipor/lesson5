...
public class MainActivity extends ListActivity implements AppResultReceiver.Receiver {
    ...
    private CarWashDatabaseHelper myDatabaseHelper;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myDatabaseHelper = CarWashDatabaseHelper.getInstance(this);
        myDatabaseHelper.open();
        //fill data
        currentCursor = myDatabaseHelper.fetchAllTitles(feedURL);

        // Create an array to specify the fields we want to display in the list (only NAME)
        String[] from = new String[]{CarWashDatabaseHelper.FEED_KEY_TITLE};
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
            ...
            String body = cursor.getString(cursor.getColumnIndexOrThrow(CarWashDatabaseHelper.FEED_KEY_BODY));
